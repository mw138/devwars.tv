angular.module('app.GameService', [])
    .factory('GameService', ['$http', function($http){
        ...
        /*
         ...
         Query Parameter {season} : java.lang.Integer
         */
        GameService.pastGames = function(offset, count, season, successCallback, errorCallback){
            $http({
                method: 'GET',
                url: '/v1/game/pastgames',
                params: {offset : offset,count : count,season : season}
            })
                .then(function(success){
                    successCallback(success)
                },
