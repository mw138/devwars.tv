angular.module('app.GameService', [])
    .factory('GameService', ['$http', function($http){
        ...
        GameService.http.upcomingTournaments = function(successCallback, errorCallback){
         ...
         Path Variable {id} : int
         */
        GameService.signUpTeamForGame = function(id, users, successCallback, errorCallback){
            $http({
                method: 'POST',
        ...
        GameService.http.signUpTeamForGame = function(id, users, successCallback, errorCallback){
            return $http({
                method: 'POST',
                url: '/v1/game/' + id + '/signupteam',
                data: {users : users}
        ...
        GameService.http.signUpForGame = function(id, successCallback, errorCallback){
         ...
         Path Variable {id} : int
         */
        GameService.pendingTeams = function(id, successCallback, errorCallback){
            $http({
                method: 'GET',
                url: '/v1/game/' + id + '/pendingteams',
                params: {}
            })
                .then(function(success){
                        successCallback(success)
        ...
        GameService.http.pendingTeams = function(id, successCallback, errorCallback){
            return $http({
                method: 'GET',
                url: '/v1/game/' + id + '/pendingteams',
                params: {}
